...
export function NotificationListener() {
  ...
  const { isAuthenticated, socketConnected } = useAuthStore();
  ...
  useEffect(() => {
    if (!notifications || !isAuthenticated || !socketConnected) return;
  ...
  }, [notifications, sounds, activeChat, toast, isAuthenticated, socketConnected]);
